import { FaFilePrescription, FaUserMd, FaClinicMedical, FaPhone, FaPlus, FaDownload } from 'react-icons/fa';
...
const Prescriptions = () => {
  ...
  const handleAddPrescription = (e) => {
    ...
    setPrescriptions([...prescriptions, rxToAdd]);
